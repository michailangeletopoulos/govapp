    ...
    <>
      ...
      <h2 className="text-2xl font-bold mb-4">Συχνές Ερωτήσεις</h2>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
          Πατώντας το κουμπί πάνω δεξία που λέει Εγγραφή μπορείτε να εγγραφείται στην υπηρεσία.
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            ...
            έπειτα βρίσκεται την φόρμα που θέλετε, και πατώντας την ανακατευθύνεστε στην σελίδα της.
            Πατώντας υποβολή θα εμφανιστεί μια φόρμα με τα στοιχεία σας που θα πρέπει να συμπληρώσετε
