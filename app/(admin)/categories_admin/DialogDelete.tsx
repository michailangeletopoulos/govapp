      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="font-bold">
            Αν διαγράψετε αυτή την κατηγορία, οι φόρμες της δεν θα σβηστούν, οι χρήστες θα έχουν πρόσβαση στις φόρμες 
            αυτής της κατηγορίας, αλλά οι υπάλληλοι δεν θα μπορούν να τις διαχειριστούν.
          </DialogDescription>
          <DialogDescription >
